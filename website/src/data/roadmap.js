  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'GCP context YAML functions', status: 'shipped', quarter: 'q1-2026', docs: '/functions/yaml/gcp.project-id', changelog: 'gcp-yaml-functions', description: 'Access GCP project, region, service account, and organization ID in stack configuration.', codeExample: 'project_id: !gcp.project_id', benefits: 'Reference GCP context dynamically. No hardcoded project IDs or region values across environments.' },
